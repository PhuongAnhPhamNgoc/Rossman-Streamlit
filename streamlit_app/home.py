...
def app():
    ...
    <p id = "data_info">The UI/UX for the app glides using the <b>Sidebar</b> to the left.&emsp;&emsp;<br>
    ...
    <b>2. Future Sale Prediction using <i>XGBRegressor and DNN (Deep Learning)</i>&emsp;&emsp;<br>
